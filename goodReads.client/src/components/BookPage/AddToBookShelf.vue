<template>
  <div class="card p-2 elevation-4 border-0 ">
    <h3
      ...
      class="ms-3 text-danger text-decoration-underline fw-bold "
    >
      {{ book.saleAbility }}
    </h3>
    ...
    <div class="card-body d-flex flex-column justify-content-center">
      <div>
          ...
          <div class="dropdown open">
            ...
            >
              <span
                v-if="shelf"
                :class="
                  shelf.hasActiveBook ? 'text-warning noSelect' : 'text-primary'
                "
                type="button"
                :disabled="shelf.hasActiveBook"
                >{{ shelf.type }}</span
              >
        ...
        >
          ...
          <div class="mt-4  " v-else>Sign in to Create a bookshelf and bookmark this book, AND create a recommendation!</div>

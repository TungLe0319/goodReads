export class Book {
  constructor(data) {
    ...
    this.isbn13 = data?.volumeInfo?.industryIdentifiers[0]?.identifier || delete this.isbn13;
    this.isbn10 = data.volumeInfo?.industryIdentifiers[1]?.identifier || delete this.isbn10
  }
}
